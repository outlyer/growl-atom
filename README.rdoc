...
A script to monitor Atom feeds and create Mountain Lion notifications for new entries. It's forked from the Growl-Atom (https://github.com/matth/growl-atom) project from Matt Haynes and mainly just swaps Growl for Mountain Lion's Notification Center. It's nice because it doesn't actually have any sort of daemon running, but uses the normal LaunchDaemons to check
periodically; not unlike Fetchmail but more lightweight. 

== Prerequisites

* Mac OS X 10.8 Mountain Lion
* Terminal Notifier (https://github.com/alloy/terminal-notifier/tree/master/Ruby)
...
> For extra credit, build your own copy of the Terminal Notifier, add the app.icns from this repository and you'll get the actual Gmail icon. I don't have a code signing key so I can't build one for you. 
